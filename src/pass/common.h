...
void BtfFunctionAddDebugInfo(
    llvm::DIBuilder& debugBuilder, llvm::Function& func, llvm::ArrayRef<llvm::Metadata*> paramTypes, llvm::ArrayRef<llvm::MDNode*> paramAnnotations = {});
