...
"""Generate tiny deterministic llama2.c v0 and Q8-v2 test checkpoints."""
...
# The context must cover the regression suite's full request (32 tokens):
# a sub-millisecond measured region moves by 2x with per-boot guest state,
# so the benchmark stretches generation to the LLAMA_MAX_STEPS cap.
