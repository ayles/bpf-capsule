...
foreach(required BPF_CAPSULE_LD LLVM_AS LLVM_DIS PIPELINE BEFORE AFTER WORK)
...
if(NOT before_recorded STREQUAL before_canonical)
    ...
    message(FATAL_ERROR
        "${BEFORE} is not canonical; canonical form: ${WORK}/before.canonical.ll")
endif()

set(actual_bc "${WORK}/actual.bc")
set(command "${BPF_CAPSULE_LD}" "--passes=${PIPELINE}" --emit-llvm -o "${actual_bc}")
...
if(NOT after_recorded STREQUAL expected)
    ...
    message(FATAL_ERROR
        "${AFTER} is not canonical; canonical form: ${WORK}/after.canonical.ll")
endif()
