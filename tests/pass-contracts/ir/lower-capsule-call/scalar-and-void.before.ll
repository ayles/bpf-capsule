...
entry:
  ...
  %status = call i32 (i32, ptr, ptr, i64, i64, ptr, ...) @__bpf_capsule_call(i32 %fiber.index, ptr %context, ptr %output, i64 8, i64 8, ptr @scalar_root, ptr %ordinary, i16 %value)
  ret i32 %status
}

define i32 @call_void(i32 %fiber.index) section "xdp" {
entry:
  %status = call i32 (i32, ptr, ptr, i64, i64, ptr, ...) @__bpf_capsule_call(i32 %fiber.index, ptr null, ptr null, i64 0, i64 1, ptr @void_root)
  ret i32 %status
}
