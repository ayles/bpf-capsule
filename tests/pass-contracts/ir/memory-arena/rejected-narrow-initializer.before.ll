source_filename = "memory-arena-narrow-initializer.ll"
...
@narrow = global ptr inttoptr (i32 ptrtoint (ptr @value to i32) to ptr), align 8
...
!3 = !DIFile(filename: "memory-arena-narrow-initializer.ll", directory: ".")
!4 = !{!0}
