source_filename = "stackify-rejected-verifier-pointer-chunk.ll"
...
define i64 @pointer_across_chunk(i64 %count) !bpf.capsule !0 {
entry:
...
entry:
  %result = call i64 @pointer_across_chunk(i64 64) [ "bpf.capsule.call"(i32 %fiber) ]
