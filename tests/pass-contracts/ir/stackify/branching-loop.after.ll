...
branching_loop.prologue:                          ; preds = %unit.test.left
  ...
  br i1 %4, label %branching_loop.prologue.overflow, label %entry
...
latch.chunk.guard:                                ; preds = %latch
  ...
  %5 = icmp ult i32 %bpf.loop.chunk.next, 8
  br i1 %5, label %latch.chunk.continue, label %latch.chunk.boundary
