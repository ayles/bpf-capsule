...
define i32 @start(i32 %fiber, i1 %choose) section "syscall" !bpf.native !2 {
entry:
...
entry:                                            ; preds = %root.prologue
  ...
  %choose1 = load i1, ptr %1, align 1
  %selected = select i1 %choose1, ptr null, ptr null
  %2 = getelementptr i8, ptr %frame.addr, i64 24
  %choose = load i1, ptr %2, align 1
