...
root.prologue:                                    ; preds = %unit.test.left
  %frame.sp = sub i64 %frame.fp, 80
  %slice.offset = and i64 %frame.fp, 262143
  %10 = icmp ult i64 %slice.offset, 131184
...
entry:                                            ; preds = %root.prologue
  ...
  %env.slot1 = getelementptr i8, ptr %frame.addr, i64 -80
  %setjmp.slot = getelementptr i8, ptr %frame.addr, i64 -48
  store i32 0, ptr %setjmp.slot, align 4
  %11 = getelementptr i8, ptr %env.slot1, i64 0
  store i32 2, ptr %11, align 4
  %fiber.sp4 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 3
  %12 = load i64, ptr %fiber.sp4, align 8
  %13 = getelementptr i8, ptr %env.slot1, i64 8
  store i64 %12, ptr %13, align 8
  %14 = getelementptr i8, ptr %env.slot1, i64 16
  store i64 %frame.fp, ptr %14, align 8
  %15 = ptrtoint ptr %setjmp.slot to i64
  %16 = getelementptr i8, ptr %env.slot1, i64 24
  store i64 %15, ptr %16, align 8
  br label %entry.setjmp.resume

entry.setjmp.resume:                              ; preds = %unit.test.right, %entry
  %17 = getelementptr i8, ptr %frame.addr, i64 -48
  %setjmp.result = load i32, ptr %17, align 4
  %first = icmp eq i32 %setjmp.result, 0
  br i1 %first, label %jump, label %done

done:                                             ; preds = %entry.setjmp.resume
  store i32 %setjmp.result, ptr %frame.addr, align 4
  %18 = getelementptr i8, ptr %frame.addr, i64 -8
  %return.pc = load i32, ptr %18, align 4
  %19 = getelementptr i8, ptr %frame.addr, i64 -16
  %saved.fp = load i64, ptr %19, align 8
...
jump:                                             ; preds = %entry.setjmp.resume
  %env.slot = getelementptr i8, ptr %frame.addr, i64 -80
  %20 = getelementptr i8, ptr %frame.addr, i64 -24
  %value = load i32, ptr %20, align 4
  %21 = icmp eq i32 %value, 0
  %longjmp.value = select i1 %21, i32 1, i32 %value
  %22 = getelementptr i8, ptr %env.slot, i64 24
  %23 = load i64, ptr %22, align 8
  %24 = inttoptr i64 %23 to ptr
  store i32 %longjmp.value, ptr %24, align 4
  %25 = getelementptr i8, ptr %env.slot, i64 8
  %26 = load i64, ptr %25, align 8
  %fiber.sp5 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 3
  store i64 %26, ptr %fiber.sp5, align 8
  %27 = getelementptr i8, ptr %env.slot, i64 16
  %28 = load i64, ptr %27, align 8
  %fiber.fp6 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 4
  store i64 %28, ptr %fiber.fp6, align 8
  %29 = getelementptr i8, ptr %env.slot, i64 0
  %30 = load i32, ptr %29, align 4
  %fiber.pc7 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 5
  store i32 %30, ptr %fiber.pc7, align 4
  ret i32 0
...
root.prologue.overflow:                           ; preds = %root.prologue
  ...
  %31 = call i32 @bpf_capsule_set_outcome(i32 %fiber, i64 -30064771069)
  ret i32 0

unit.test.left:                                   ; preds = %unit.control.ready
  %32 = icmp eq i32 %pc4, 1
  br i1 %32, label %root.prologue, label %unit.unknown

unit.test.right:                                  ; preds = %unit.control.ready
  %33 = icmp eq i32 %pc4, 2
  br i1 %33, label %entry.setjmp.resume, label %unit.unknown

unit.unknown:                                     ; preds = %unit.test.right, %unit.test.left
  %34 = call i32 @bpf_capsule_set_outcome(i32 %fiber, i64 -38654705661)
  ret i32 0
}
