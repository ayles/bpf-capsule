...
entry:                                            ; preds = %root.prologue
  ...
  %1 = getelementptr i8, ptr %env.slot1, i64 0
  store i32 512, ptr %1, align 4
  %fiber.sp4 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 3
  %2 = load i64, ptr %fiber.sp4, align 8
  %3 = getelementptr i8, ptr %env.slot1, i64 8
  store i64 %2, ptr %3, align 8
  %4 = getelementptr i8, ptr %env.slot1, i64 16
  store i64 %frame.fp, ptr %4, align 8
  %5 = ptrtoint ptr %setjmp.slot to i64
  %6 = getelementptr i8, ptr %env.slot1, i64 24
  store i64 %5, ptr %6, align 8
  br label %entry.setjmp.resume

entry.setjmp.resume:                              ; preds = %unit.test.right, %entry
  %7 = getelementptr i8, ptr %frame.addr, i64 -16
  %setjmp.result = load i32, ptr %7, align 4
  ...
  %return.region.id = load i32, ptr %8, align 4
...
jump:                                             ; preds = %entry.setjmp.resume
  ...
  %11 = icmp eq i32 %value, 0
  %longjmp.value = select i1 %11, i32 1, i32 %value
  %12 = getelementptr i8, ptr %env.slot, i64 24
  %13 = load i64, ptr %12, align 8
  %14 = inttoptr i64 %13 to ptr
  store i32 %longjmp.value, ptr %14, align 4
  %15 = getelementptr i8, ptr %env.slot, i64 8
  %16 = load i64, ptr %15, align 8
  %fiber.sp5 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 3
  store i64 %16, ptr %fiber.sp5, align 8
  %17 = getelementptr i8, ptr %env.slot, i64 16
  %18 = load i64, ptr %17, align 8
  %fiber.fp6 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 4
  store i64 %18, ptr %fiber.fp6, align 8
  %19 = getelementptr i8, ptr %env.slot, i64 0
  %20 = load i32, ptr %19, align 4
  %fiber.resume.region.id7 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 5
  store i32 %20, ptr %fiber.resume.region.id7, align 4
  ret i32 0
...
root.prologue.overflow:                           ; preds = %root.prologue
  ...
  %21 = call i32 @bpf_capsule_set_outcome(i32 %fiber, i64 -30064771069)
  ret i32 1

unit.dispatch1:                                   ; preds = %unit.dispatch
  %22 = icmp ult i32 %region, 512
  br i1 %22, label %unit.test.left, label %unit.test.right
...
bad.id:                                           ; preds = %entry
  %1 = call i32 @bpf_capsule_set_outcome(i32 %fiber, i64 -38654705661)
  ret i32 1

bpf.unit.0:                                       ; preds = %unit.route
  %2 = call i32 @bpf.unit.0(i32 %fiber, ptr %fiber_control, i32 %region)
  ret i32 %2
}
