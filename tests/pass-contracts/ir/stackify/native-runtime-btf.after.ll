...
define internal i64 @__bpf_runtime_glue(i32 %value) !dbg !6 {
entry:
  %wide = zext i32 %value to i64, !dbg !13
  ret i64 %wide, !dbg !13
}

define i32 @start(i32 %fiber) section "syscall" !bpf.native !14 {
entry:
  ...
  %fiber.control = getelementptr inbounds [1 x %fiber_control], ptr @bpf_capsule_fibers, i32 0, i32 %fiber.index2, !bpf.capsule.sectioned.bounded !14
  ...
  %fiber.control4 = getelementptr inbounds [1 x %fiber_control], ptr @bpf_capsule_fibers, i32 0, i32 %fiber.index3, !bpf.capsule.sectioned.bounded !14
  ...
  %fiber.control6 = getelementptr inbounds [1 x %fiber_control], ptr @bpf_capsule_fibers, i32 0, i32 %fiber.index5, !bpf.capsule.sectioned.bounded !14
  ...
  %fiber.control8 = getelementptr inbounds [1 x %fiber_control], ptr @bpf_capsule_fibers, i32 0, i32 %fiber.index7, !bpf.capsule.sectioned.bounded !14
  ...
  %fiber.control10 = getelementptr inbounds [1 x %fiber_control], ptr @bpf_capsule_fibers, i32 0, i32 %fiber.index9, !bpf.capsule.sectioned.bounded !14
...
define i32 @bpf_capsule_set_outcome(i32 %fiber, i64 %outcome) #1 !dbg !15 !bpf.native.scalar !14 {
entry:
  %fiber.index = and i32 %fiber, 0, !dbg !21
  %fiber.control = getelementptr inbounds [1 x %fiber_control], ptr @bpf_capsule_fibers, i32 0, i32 %fiber.index, !dbg !21, !bpf.capsule.sectioned.bounded !14
...
; Function Attrs: noinline
define i32 @__bpf_capsule_trampoline_step(i32 %fiber, ptr "bpf.capsule.control" %fiber_control) #2 !dbg !22 !bpf.capsule !14 !bpf.capsule.allocation.unit !34 !bpf.capsule.stack.size !0 {
unit.entry:
...
root.prologue.overflow:                           ; preds = %root.prologue
  ...
  %11 = call i32 @bpf_capsule_set_outcome(i32 %fiber, i64 -30064771069), !dbg !35
  ret i32 0
...
unit.unknown:                                     ; preds = %unit.test.right, %unit.test.left
  %17 = call i32 @bpf_capsule_set_outcome(i32 %fiber, i64 -38654705661), !dbg !35
  ret i32 0, !dbg !35
}
...
!6 = distinct !DISubprogram(name: "__bpf_runtime_glue", linkageName: "__bpf_runtime_glue", scope: null, file: !2, type: !7, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !1, retainedNodes: !11)
!7 = !DISubroutineType(types: !8)
!8 = !{!9, !10}
!9 = !DIBasicType(name: "long long", size: 64, encoding: DW_ATE_signed)
!10 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!11 = !{!12}
!12 = !DILocalVariable(name: "a0", arg: 1, scope: !6, file: !2, type: !10)
!13 = !DILocation(line: 0, scope: !6)
!14 = !{}
!15 = distinct !DISubprogram(name: "bpf_capsule_set_outcome", linkageName: "bpf_capsule_set_outcome", scope: null, file: !2, type: !16, spFlags: DISPFlagDefinition, unit: !1, retainedNodes: !18)
!16 = !DISubroutineType(types: !17)
!17 = !{!10, !10, !9}
!18 = !{!19, !20}
!19 = !DILocalVariable(name: "a0", arg: 1, scope: !15, file: !2, type: !10)
!20 = !DILocalVariable(name: "a1", arg: 2, scope: !15, file: !2, type: !9)
