source_filename = "stackify-rejected-fiber-count.ll"
...
@bpf_capsule_config = constant %config { i32 0, i32 4096, i32 0, i32 0, i32 0, i32 4096, i32 0, i32 0, i32 1, i32 0, i32 1112556353, i32 6, i64 0, i64 0 }, section ".rodata.bpfconfig", align 4
...
entry:
  %control = getelementptr [0 x %fiber_control], ptr @bpf_capsule_fibers, i32 0, i32 %fiber
