...
root.prologue:                                    ; preds = %unit.test.left
  ...
  %3 = icmp ult i64 %slice.offset, 131120
...
entry.resume:                                     ; preds = %unit.test.left2
  ...
  store i32 4, ptr %return.pc.slot11, align 4
  %7 = getelementptr i8, ptr %callee.frame9, i64 24
  store i1 false, ptr %7, align 8
  %fiber.pc12 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 5
  store i32 2, ptr %fiber.pc12, align 4
