...
entry.resume:                                     ; preds = %unit.test.left2
  ...
  %callee.fp6 = sub i64 %frame.fp, 64
  %return.pc.slot7 = getelementptr i8, ptr %frame.addr, i64 -72
  store i32 4, ptr %return.pc.slot7, align 4
  %saved.fp.slot8 = getelementptr i8, ptr %frame.addr, i64 -80
  store i64 %frame.fp, ptr %saved.fp.slot8, align 8
  ...
  store i32 2, ptr %fiber.pc9, align 4
  %fiber.fp10 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 4
  store i64 %callee.fp6, ptr %fiber.fp10, align 8
  ret i32 0

entry.resume.resume:                              ; preds = %unit.test.right3
  %result.zone11 = getelementptr i8, ptr %frame.addr, i64 -64
  ...
  %sum = add i32 %first.reload, %callret12
