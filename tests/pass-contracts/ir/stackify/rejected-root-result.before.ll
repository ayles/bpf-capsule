source_filename = "stackify-rejected-root-result.ll"
...
define [262144 x i8] @root() !bpf.capsule !0 {
entry:
  ret [262144 x i8] zeroinitializer
}

define i32 @start(i32 %fiber) section "syscall" !bpf.native !0 {
entry:
  %result = call [262144 x i8] @root() [ "bpf.capsule.call"(i32 %fiber) ]
  ret i32 0
}
