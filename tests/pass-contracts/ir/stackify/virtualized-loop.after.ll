...
virtualized_loop.prologue:                        ; preds = %unit.test.left
  ...
  br i1 %0, label %virtualized_loop.prologue.overflow, label %entry
...
entry:                                            ; preds = %virtualized_loop.prologue
  ...
  %index.reg2mem.slot2 = getelementptr i8, ptr %frame.addr, i64 -16
  store i32 0, ptr %index.reg2mem.slot2, align 4
  br label %loop

loop:                                             ; preds = %unit.test.right, %entry
  %index.reg2mem.slot = getelementptr i8, ptr %frame.addr, i64 -16
...
unit.dispatch1:                                   ; preds = %unit.dispatch
  %5 = icmp ult i32 %region, 512
  br i1 %5, label %unit.test.left, label %unit.test.right
