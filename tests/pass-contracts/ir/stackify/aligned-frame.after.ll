...
entry:
  ...
  %4 = mul i64 %3, 262144
  %stack.linear.offset12 = add i64 %4, 262112
...
root.prologue:                                    ; preds = %unit.control.ready
  ...
  %10 = icmp ult i64 %slice.offset, 131168
...
entry:                                            ; preds = %root.prologue
  ...
  %scratch.slot1 = getelementptr i8, ptr %frame.addr, i64 -64
  store i8 7, ptr %scratch.slot1, align 32
  %scratch.slot = getelementptr i8, ptr %frame.addr, i64 -64
  %byte = load i8, ptr %scratch.slot, align 32
  %extended = zext i8 %byte to i128
  %11 = getelementptr i8, ptr %frame.addr, i64 -32
  %value = load i128, ptr %11, align 16
  %result = add i128 %value, %extended
  store i128 %result, ptr %frame.addr, align 16
