...
entry:
  ...
  %2 = getelementptr i8, ptr %fiber.stack, i64 32
  ...
  store i32 16, ptr %fiber.return.size, align 4
  ...
  %4 = mul i64 %3, 262144
  %stack.linear.offset12 = add i64 %4, 262096
  %fiber.stack13 = getelementptr i8, ptr @bpf_call_stack, i64 %stack.linear.offset12
  %root.result = load i128, ptr %fiber.stack13, align 16
  %truncated = trunc i128 %root.result to i32
  ret i32 %truncated
}
...
root.prologue:                                    ; preds = %unit.dispatch1
...
entry:                                            ; preds = %root.prologue
  ...
  %scratch.slot1 = getelementptr i8, ptr %frame.addr, i64 -32
  store i8 7, ptr %scratch.slot1, align 32
  %scratch.slot = getelementptr i8, ptr %frame.addr, i64 -32
  %byte = load i8, ptr %scratch.slot, align 32
  %extended = zext i8 %byte to i128
  %1 = getelementptr i8, ptr %frame.addr, i64 32
  %value = load i128, ptr %1, align 16
  %result = add i128 %value, %extended
  %result.slot = getelementptr i8, ptr %frame.addr, i64 16
  store i128 %result, ptr %result.slot, align 16
