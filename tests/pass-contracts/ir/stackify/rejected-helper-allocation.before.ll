source_filename = "stackify-rejected-helper-allocation.ll"
...
define i64 @root(i64 %count) !bpf.capsule !0 {
entry:
  %buffer = alloca i8, i64 %count, align 8
  %result = call i64 inttoptr (i64 1 to ptr)(ptr null, ptr %buffer)
  ret i64 %result
}

define i32 @start(i32 %fiber) section "syscall" !bpf.native !0 {
entry:
  %result = call i64 @root(i64 8) [ "bpf.capsule.call"(i32 %fiber) ]
