...
entry:
  ...
  %5 = mul i64 %4, 262144
  %stack.linear.offset12 = add i64 %5, 262112
...
entry:                                            ; preds = %root.prologue
  ...
  %frame_alignment.slot = getelementptr i8, ptr %frame.addr, i64 -64
...
entry.carve:                                      ; preds = %entry
  ...
  %11 = add i64 %frontier.next, 32
  %frame.addr5 = inttoptr i64 %11 to ptr
  %vla.handle = getelementptr i8, ptr %frame.addr, i64 -56
  store ptr %frame.addr5, ptr %vla.handle, align 8
  %12 = getelementptr i8, ptr %frame.addr, i64 -56
  %vla7 = load ptr, ptr %12, align 8
  store i8 5, ptr %vla7, align 1
  %13 = getelementptr i8, ptr %frame.addr, i64 -32
  %value = load i32, ptr %13, align 4
  %fiber.sp11 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 3
  %frontier12 = load i64, ptr %fiber.sp11, align 8
  %frame.addr13 = inttoptr i64 %frontier12 to ptr
  %return.pc.slot = getelementptr i8, ptr %frame.addr13, i64 -8
  store i32 3, ptr %return.pc.slot, align 4
  %saved.fp.slot = getelementptr i8, ptr %frame.addr13, i64 -16
  store i64 %frame.fp, ptr %saved.fp.slot, align 8
  %14 = getelementptr i8, ptr %frame.addr13, i64 -24
  store i32 %value, ptr %14, align 4
  %fiber.pc14 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 5
  store i32 1, ptr %fiber.pc14, align 4
  %fiber.fp15 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 4
  store i64 %frontier12, ptr %fiber.fp15, align 8
  ret i32 0
...
root.prologue.overflow:                           ; preds = %root.prologue
  ...
  %16 = call i32 @bpf_capsule_set_outcome(i32 %fiber, i64 -30064771069)
  ret i32 0

entry.carve.resume:                               ; preds = %unit.test.left2
  %fiber.sp16 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 3
  %frontier.resume = load i64, ptr %fiber.sp16, align 8
  %frame.addr17 = inttoptr i64 %frontier.resume to ptr
  %result.zone = getelementptr i8, ptr %frame.addr17, i64 0
  %callret = load i32, ptr %result.zone, align 4
  %fiber.sp18 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 3
  %frontier19 = load i64, ptr %fiber.sp18, align 8
  %frame.addr20 = inttoptr i64 %frontier19 to ptr
  %return.pc.slot21 = getelementptr i8, ptr %frame.addr20, i64 -8
  store i32 4, ptr %return.pc.slot21, align 4
  %saved.fp.slot22 = getelementptr i8, ptr %frame.addr20, i64 -16
  store i64 %frame.fp, ptr %saved.fp.slot22, align 8
  %17 = getelementptr i8, ptr %frame.addr20, i64 -24
  store i32 %callret, ptr %17, align 4
  %fiber.pc23 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 5
  store i32 1, ptr %fiber.pc23, align 4
  %fiber.fp24 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 4
  store i64 %frontier19, ptr %fiber.fp24, align 8
  ret i32 0

entry.carve.resume.resume:                        ; preds = %unit.test.right3
  %fiber.sp25 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 3
  %frontier.resume26 = load i64, ptr %fiber.sp25, align 8
  %frame.addr27 = inttoptr i64 %frontier.resume26 to ptr
  %result.zone28 = getelementptr i8, ptr %frame.addr27, i64 0
  %callret29 = load i32, ptr %result.zone28, align 4
  %18 = getelementptr i8, ptr %frame.addr, i64 -56
  %vla6 = load ptr, ptr %18, align 8
  %byte = load i8, ptr %vla6, align 1
  %extended = zext i8 %byte to i32
  %result = add i32 %callret29, %extended
  store i32 %result, ptr %frame.addr, align 4
  %19 = getelementptr i8, ptr %frame.addr, i64 -8
  %return.pc = load i32, ptr %19, align 4
  %20 = getelementptr i8, ptr %frame.addr, i64 -16
  ...
  store i64 %frame.fp, ptr %fiber.sp9, align 8
