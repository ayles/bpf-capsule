...
root.prologue:                                    ; preds = %unit.test.left
  ...
  %0 = icmp ult i64 %slice.offset, 131136
...
entry:                                            ; preds = %root.prologue
  ...
  %count8 = load i64, ptr %1, align 8
  %2 = icmp ugt i64 %count8, 262144
  ...
  %4 = add i64 %carve.reserve, 131104
  %5 = icmp ult i64 %slice.offset2, %4
  %carve.overflow = or i1 %2, %5
  br i1 %carve.overflow, label %entry.carve.abort, label %entry.carve

entry.carve:                                      ; preds = %entry
  %6 = sub i64 %frontier, %carve.bytes
  %frontier.next = and i64 %6, -32
  ...
  %7 = getelementptr i8, ptr %frame.addr, i64 -24
  %vla7 = load ptr, ptr %7, align 8
  store i8 5, ptr %vla7, align 1
  %8 = getelementptr i8, ptr %frame.addr, i64 32
  %value = load i32, ptr %8, align 4
  ...
  %return.region.id.slot = getelementptr i8, ptr %frame.addr12, i64 8
  store i32 512, ptr %return.region.id.slot, align 4
  %9 = getelementptr i8, ptr %frame.addr12, i64 24
  store i32 %value, ptr %9, align 8
...
entry.carve.resume:                               ; preds = %unit.test.left2
  ...
  %return.region.id.slot25 = getelementptr i8, ptr %frame.addr23, i64 8
  store i32 768, ptr %return.region.id.slot25, align 4
  %12 = getelementptr i8, ptr %frame.addr23, i64 24
  store i32 %callret, ptr %12, align 8
  %fiber.resume.region.id26 = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 5
  store i32 1024, ptr %fiber.resume.region.id26, align 4
...
entry.carve.resume.resume:                        ; preds = %unit.test.right3
  ...
  %13 = getelementptr i8, ptr %frame.addr, i64 -24
  %vla6 = load ptr, ptr %13, align 8
...
ordinary_helper.prologue:                         ; preds = %unit.dispatch1
  %frame.sp = sub i64 %frame.fp, 0
  %slice.offset = and i64 %frame.fp, 262143
  %0 = icmp ult i64 %slice.offset, 131104
  br i1 %0, label %ordinary_helper.prologue.overflow, label %entry
