...
; Function Attrs: noinline
define i32 @bpf.unit.0(i32 %fiber, ptr "bpf.capsule.control" %fiber_control, i32 %region) #2 !bpf.capsule !2 !bpf.capsule.allocation.unit !3 !bpf.capsule.stack.size !0 !bpf.capsule.flatten.unit !4 {
unit.entry:
...
entry.resume:                                     ; preds = %unit.test.left2
  ...
  %4 = getelementptr i8, ptr %callee.frame10, i64 24
  store i32 %native, ptr %4, align 8
...
entry.resume.resume:                              ; preds = %unit.test.right3
  ...
  %first.reg2mem.slot2 = getelementptr i8, ptr %frame.addr, i64 -16
...
; Function Attrs: noinline
define i32 @bpf.unit.1(i32 %fiber, ptr "bpf.capsule.control" %fiber_control, i32 %region) #2 !bpf.capsule !2 !bpf.capsule.allocation.unit !3 !bpf.capsule.stack.size !0 !bpf.capsule.flatten.unit !4 {
unit.entry:
  %fiber.fp = getelementptr inbounds nuw %fiber_control, ptr %fiber_control, i32 0, i32 4
  %frame.fp = load i64, ptr %fiber.fp, align 8
  %frame.addr = inttoptr i64 %frame.fp to ptr
...
; Function Attrs: noinline
define i32 @__bpf_capsule_trampoline_step(i32 %fiber, ptr "bpf.capsule.control" %fiber_control) #3 {
entry:
...
; Function Attrs: noinline
define i32 @bpf.dispatch.output.scalar.0(i32 %fiber, ptr "bpf.capsule.control" %fiber_control, i32 %region) #2 !bpf.capsule.flatten.root !4 {
entry:
  %0 = icmp ne ptr %fiber_control, null
