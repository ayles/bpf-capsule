...
chunked_loop.prologue:                            ; preds = %unit.test.left
  ...
  br i1 %10, label %chunked_loop.prologue.overflow, label %entry
...
loop.chunk.guard:                                 ; preds = %loop
  ...
  %14 = icmp ult i32 %bpf.loop.chunk.next, 16
  br i1 %14, label %loop.chunk.continue, label %loop.chunk.boundary
...
unit.test.left:                                   ; preds = %unit.control.ready
  %16 = icmp eq i32 %pc4, 1
  br i1 %16, label %chunked_loop.prologue, label %unit.unknown

unit.test.right:                                  ; preds = %unit.control.ready
  %17 = icmp eq i32 %pc4, 2
