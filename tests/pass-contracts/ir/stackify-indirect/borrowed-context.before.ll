...
entry:
  ...
  %scalar = call i32 @scalar_helper(i32 %first)
  %second = call i32 @context_helper(i32 %scalar)
  %result = call i32 @scalar_helper(i32 %second)
  ret i32 %result
}

define i32 @scalar_helper(i32 %value) !bpf.capsule !4 {
entry:
  %result = add i32 %value, 1
  ret i32 %result
}
...
entry:
  %result = call i32 @scalar_helper(i32 5) [ "bpf.capsule.call"(i32 %fiber) ]
  ret i32 %result
}
