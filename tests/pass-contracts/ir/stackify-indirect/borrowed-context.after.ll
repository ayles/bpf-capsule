...
unit.dispatch1:                                   ; preds = %unit.dispatch
  %8 = icmp ult i32 %region, 3, !dbg !54
...
dispatch:                                         ; preds = %route
  ...
  %region.index = lshr i32 %resume.region.id, 8, !dbg !76
...
bad.id:                                           ; preds = %dispatch, %entry
  %1 = call i32 @bpf_capsule_set_outcome(i32 %fiber, i64 -38654705661), !dbg !82
  ret i32 1, !dbg !82

bpf.unit.0:                                       ; preds = %dispatch, %dispatch, %dispatch, %dispatch, %dispatch
  %2 = call i32 @bpf.unit.0(i32 %fiber, ptr %fiber_control, i32 %region), !dbg !82
  ret i32 %2, !dbg !82

bpf.unit.1:                                       ; preds = %dispatch
  %3 = call i32 @bpf.unit.1(i32 %fiber, ptr %fiber_control, i32 %region), !dbg !82
  ret i32 %3, !dbg !82
}
...
dispatch:                                         ; preds = %route
  ...
  %region.index = lshr i32 %resume.region.id, 8, !dbg !88
  switch i32 %step.index, label %bad.id [
