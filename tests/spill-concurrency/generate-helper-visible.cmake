...
if(NOT DEFINED OUTPUT
   ...
   OR WORD_COUNT LESS 48
)
    message(FATAL_ERROR "generate-helper-visible.cmake needs OUTPUT and WORD_COUNT >= 48")
endif()
...
string(
    ...
    "define dso_local i64 @helper_visible(i64 %seed) #0 !bpf.capsule !1 !bpf.capsule.physical !0 !bpf.capsule.stack.size !2 {\n"
    "entry:\n"
    "  %guard = alloca [64 x i8], align 8\n"
    "  %buffer = alloca [384 x i8], align 8\n"
)
...
string(
    ...
    "  %buffer.first = getelementptr inbounds [384 x i8], ptr %buffer, i64 0, i64 0\n"
    "  store volatile i8 0, ptr %buffer.first, align 8\n"
    "  %helper.result = call i64 inttoptr (i64 113 to ptr)(ptr %buffer.first, i32 384, ptr null)\n"
)
foreach(index RANGE 0 ${last_word})
    string(APPEND ir "  %input${index} = load volatile i64, ptr @helper_visible_noise, align 8\n"
